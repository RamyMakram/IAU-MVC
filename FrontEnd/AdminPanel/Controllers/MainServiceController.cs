...
namespace AdminPanel.Controllers
{
	public class MainServiceController : BaseController
	{
		...
		public void LoadEditOrCreate()
		{
			...
			var Services = JsonConvert.DeserializeObject<ICollection<UnitsDTO>>(res.result.ToString());
			if (isar)
				ViewBag.Units = new SelectList(Services, "Units_ID", "Units_Name_AR");
			else
				ViewBag.Units = new SelectList(Services, "Units_ID", "Units_Name_EN");
		}
