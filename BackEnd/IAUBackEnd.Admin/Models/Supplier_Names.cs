...
namespace IAUBackEnd.Admin.Models
{
    ...
    public partial class Supplier_Names
    {
        ...
        public int Supplier_Names_ID { get; set; }
        public string Supplier_Names_Name_AR { get; set; }
        public string Supplier_Names_Name_EN { get; set; }
