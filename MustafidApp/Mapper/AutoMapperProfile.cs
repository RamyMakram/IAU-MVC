    ...
    public class AutoMapperProfile : Profile
    {
        ...
        public AutoMapperProfile(IConfiguration _configuration)
        {
            ...
            CreateMap<PhoneNumberNotification, NotificationsDTO>()
                ...
                .ForMember(dest => dest.Noti_Readed, src => src.MapFrom(src => src.Readed))
                .ReverseMap();
            ...
            CreateMap<RequestDatum, RequestDTO>()
                ...
                .ForMember(dest => dest.PD_F_Name, src => src.MapFrom(src => src.PersonelData.FirstName))
                .ForMember(dest => dest.PD_M_Name, src => src.MapFrom(src => src.PersonelData.MiddleName))
                .ForMember(dest => dest.PD_L_Name, src => src.MapFrom(src => src.PersonelData.LastName))
                .ForMember(dest => dest.PD_IAUNumber, src => src.MapFrom(src => src.PersonelData.IauIdNumber))
                .ForMember(dest => dest.PD_APP_ID, src => src.MapFrom(src => src.PersonelData.ApplicantTypeId))
                .ForMember(dest => dest.PD_TitleNames_ID, src => src.MapFrom(src => src.PersonelData.TitleMiddleNamesId))
                .ForMember(dest => dest.PD_National_ID, src => src.MapFrom(src => src.PersonelData.NationalityId))
                .ForMember(dest => dest.PD_ID_Doc_ID, src => src.MapFrom(src => src.PersonelData.IdDocument))
                .ForMember(dest => dest.PD_ID_Number, src => src.MapFrom(src => src.PersonelData.IdNumber))
                .ForMember(dest => dest.PD_C_ID, src => src.MapFrom(src => src.PersonelData.CountryId))
                .ForMember(dest => dest.PD_Address_C_ID, src => src.MapFrom(src => src.PersonelData.AddressCountryId))
                .ForMember(dest => dest.PD_Address_City_ID, src => src.MapFrom(src => src.PersonelData.AddressCityId))
                .ForMember(dest => dest.PD_Adress_R_ID, src => src.MapFrom(src => src.PersonelData.AdressRegionId))
                .ForMember(dest => dest.PD_Address_City, src => src.MapFrom(src => src.PersonelData.AddressCity))
                .ForMember(dest => dest.PD_Adress_Region, src => src.MapFrom(src => src.PersonelData.AdressRegion))
                .ForMember(dest => dest.PD_Postal, src => src.MapFrom(src => src.PersonelData.PostalCode))
                .ForMember(dest => dest.PD_mail, src => src.MapFrom(src => src.PersonelData.Email))
                .ForMember(dest => dest.PD_Phone, src => src.MapFrom(src => src.PersonelData.Mobile))
                .ForMember(dest => dest.Req_Code, src => src.MapFrom(src => src.CodeGenerate))
                .ForMember(dest => dest.Req_Added_Date, src => src.MapFrom(src => src.CreatedDate))
                .ForMember(dest => dest.Req_Subject, src => src.MapFrom(src => src.Unit))
            ...
            //    .ForMember(dest => dest.Req_Code, src => src.MapFrom(src => src.CodeGenerate))
            //    .ForMember(dest => dest.PD_IAUNumber, src => src.MapFrom(src => src.PersonelData.IauIdNumber))
            //    .ForMember(dest => dest.PD_TitleNames_ID, src => src.MapFrom(src => src.PersonelData.TitleMiddleNames))
            //    .ForMember(dest => dest.PD_F_Name, src => src.MapFrom(src => src.First_Name))
            //    .ForMember(dest => dest.PD_M_Name, src => src.MapFrom(src => src.Middle_Name))
            //    .ForMember(dest => dest.PD_L_Name, src => src.MapFrom(src => src.Last_Name))
            //    .ForMember(dest => dest.PD_National_ID, src => src.MapFrom(src => src.Nationality_ID))
